...
2. Read the supplied video and campaign text: record the opening line (the headline repeats it, `references/copy/message-match.md`), its length, the presenter or product frame that becomes the poster, and the offer it states.
