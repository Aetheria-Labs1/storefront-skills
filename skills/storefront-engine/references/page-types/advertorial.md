...
2. Read the supplied campaign material: record its hook, first-person or contrarian voice, audience, and the scene the hero must echo (`references/copy/message-match.md`). Select a real frame when the ad was video.
