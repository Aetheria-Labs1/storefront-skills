...
| `faq` (recommended) | returns on gifts, wrap and note, what the recipient sees, exchanges for size. | no. | FAQ island in single-open mode. | four to six questions, answer first, 60 words each. | support data and the policy ledger rows. |
