...
2. Read the supplied retargeting campaign message: record the objection angle it leads with, the offer it states, and the segment (PDP viewer, cart abandoner, content visitor). Use `references/copy/message-match.md` for the H1.
