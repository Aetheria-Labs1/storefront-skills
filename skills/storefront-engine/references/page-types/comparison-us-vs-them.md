...
2. When a comparison ad drives the traffic, read the supplied creative: record the two columns and its claim, which the H1 repeats (`references/copy/message-match.md`). Search traffic uses the query as typed.
