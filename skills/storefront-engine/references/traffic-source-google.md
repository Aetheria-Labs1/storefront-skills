...
<section class="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-16" style="background:var(--lx-bg-color)">
  ...
  <div class="flex flex-col justify-center space-y-4">
    <div class="flex items-center gap-2">
      ...
      <span class="text-sm font-medium" style="color:var(--lx-text-muted)">{{average_rating}}/5 from {{review_total}} reviews</span>
    </div>
...
<section class="py-12 lg:py-20 px-4" style="background:linear-gradient(135deg, var(--lx-bg-surface) 0%, var(--lx-bg-color) 100%)">
  <div class="max-w-6xl mx-auto text-center">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl mx-auto">
      ...
      <div class="p-4 rounded-lg" style="background:var(--lx-bg-color);border:1px solid var(--lx-border-color)">
        <div class="text-2xl font-bold mb-2" style="color:var(--lx-accent-color)">{{average_rating}}/5</div>
        <div class="text-sm" style="color:var(--lx-text-muted)">from {{review_total}} reviews</div>
      </div>
    </div>
  </div>
</section>
    ...
    <div data-island="CompareTable" data-props='{
      ...
      "rows": [
        ...
        },
        {
          ...
          "values": ["{{average_rating}}/5 ({{review_total}})", "<competitor, sourced>", "<competitor, sourced>"]
        }
      ]
    }'></div>
...
- Do: "{{review_total}} verified reviews ({{average_rating}}/5 average)" — both numbers from `lexsis_catalog` action `reviews`, never typed
  ...
  <div class="max-w-6xl mx-auto">
    <div data-island="TrustBadgeBar" data-props='{
      "badges": [
        ...
        {"icon": "award", "label": "{{average_rating}}/5 Rating", "sublabel": "From {{review_total}} reviews"}
      ],
      "layout": "horizontal"
    }'></div>
  </div>
...
```json
{
  ...
  "head": {
    ...
    "description": "Triple-strength omega-3 with 2,847mg per serving. Third-party tested for purity. {{average_rating}}/5 from {{review_total}} reviews. 90-day guarantee. Free shipping.",
