---
name: extract-island
description: MAINTAINER TOOL — analyze a component on any webpage and output a renderer-compatible island layout JSON for contribution back to this repo. Use when reverse-engineering a hero, FAQ, nav, or product card into a reusable Lexsis layout.
...
```
skills/storefront-engine/references/islands/{island-name}/layouts/{variant-slug}.json
```
