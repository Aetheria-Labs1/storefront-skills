...
See `generation-protocol.md` for the full Phase 0-4 execution protocol (context gathering, asset preparation, HTML generation, validation, publishing + visual verification).
