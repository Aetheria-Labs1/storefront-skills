...
> Inspect, assign, design, compose, or preview Lexsis cart profiles. Supports responsive design, scoped CSS, custom source-format modules, and read-only promotion diagnostics.
